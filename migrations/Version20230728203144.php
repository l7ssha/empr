...
final class Version20230728203144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film_developments (id VARCHAR(36) NOT NULL, kit_id VARCHAR(36) NOT NULL, film_id VARCHAR(36) NOT NULL, created_by_id VARCHAR(36) NOT NULL, customer_id VARCHAR(36) DEFAULT NULL, development_number VARCHAR(255) NOT NULL, notes TEXT NOT NULL, PRIMARY KEY(id))');
